    ...
    var body: some View {
        NavigationView {
            VStack(spacing: 0) { // Use spacing: 0 for tighter control
                ...
                // 2. Custom Search Bar (Manual Placement)
                HStack {
                ...
                .padding(.horizontal)
                .padding(.vertical, 8)
                .background(Color.highlightColor2.opacity(0.1))
                .cornerRadius(8)
                .padding(.horizontal)
                .padding(.top, 5) // Add slight separation from the header
                ...
                ScrollView(.horizontal, showsIndicators: false) {
                    ...
                    .padding(.horizontal)
                    .padding(.bottom, 10) // Space above the list
                }
            ...
            .navigationTitle("") // Hide the Navigation bar's title area
            .navigationBarHidden(true) // Hide the Navigation bar entirely to prevent space reservation
        }
        .onAppear {
            if !loaded {
