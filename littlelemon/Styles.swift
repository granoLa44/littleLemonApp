...
extension Font {
    static func displayFont() -> Font {
        return Font.custom("Al Firat Regular", size: 40).weight(.medium)
    }
    
    static func subTitleFont() -> Font {
        return Font.custom("Markazi Text Medium", size: 32)
    }
    
    static func leadText() -> Font {
        return Font.custom("Al Firat Regular", size: 16).weight(.medium)
    }
    
    static func regularText() -> Font {
        return Font.custom("Markazi Text Medium", size: 18)
    }
